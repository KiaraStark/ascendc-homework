...
#include "SoftmaxCustom_op_resource.h"
...
TensorDesc outputDesc0_1[3] =
    {{ge::DT_FLOAT16, ge::FORMAT_ND},
     {ge::DT_FLOAT16, ge::FORMAT_ND},
     {ge::DT_FLOAT16, ge::FORMAT_ND}};
SupportInfo list0_0 = {inputDesc0_0, 1, outputDesc0_0, 3};
SupportInfo list0_1 = {inputDesc0_1, 1, outputDesc0_1, 3};
...
[[maybe_unused]] uint32_t NNOPBASE_SoftmaxCustom = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
...
#ifdef ACLNN_WITH_BINARY
    static uint32_t SoftmaxCustomOpTypeId = op::GenOpTypeId("SoftmaxCustom", SoftmaxCustom_RESOURCES);
#endif
    static NnopbaseDfxId dfxId = {0x60000, __func__, false};
    static NnopbaseDfxId tilingId = {0x60000, "aclnnSoftmaxCustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "SoftmaxCustom";
    char inputDesc[] = {1};
    char outputDesc[] = {1, 1, 1};
    char attrDesc[] = {};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(x);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(maxOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(sumOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(zOut);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
...
#ifdef ACLNN_WITH_BINARY
    NnopbaseAddOpTypeId(*executor, SoftmaxCustomOpTypeId);
#endif
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddInput(*executor, x, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, maxOut, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, sumOut, 1));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, zOut, 2));
    ...
    if (NnopbaseAddParamName != NULL) {
        ...
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "maxOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "sumOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 2, "zOut", false));
    }
